  ...
  return (
    <>
      <button
        ...
        className="grid size-11 place-items-center rounded-full border border-white/15 bg-white/6 text-white/90 transition duration-300 hover:border-white/30 hover:bg-white hover:text-[#2d528c]"
      >
        ...
        {isOpen && (
          ...
          >
            ...
            <motion.aside
              ...
              className="absolute right-0 top-0 flex h-full w-full max-w-107.5 flex-col bg-[#fbfaf7] text-[#272a31] shadow-[-22px_0_55px_rgba(13,24,48,0.2)]"
            >
