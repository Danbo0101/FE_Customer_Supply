...
export function CustomerSearch({ isOpen, onOpenChange }: CustomerSearchProps) {
        ...
        {isOpen && (
          ...
          >
            <input
              ...
              className="h-11 w-[240px] rounded-full border border-white/20 bg-white px-4 text-sm font-medium text-[#263247] outline-none transition placeholder:text-[#8b93a2] focus:border-white focus:ring-4 focus:ring-white/20"
            />
          </motion.div>
        )}
      </AnimatePresence>
